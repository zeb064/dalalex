...
export default function Header({ comercio, onWhatsApp, onInfoClick, categorias, activeCategory, onSelectCategory }) {
  ...
  const handleTabChange = (index) => {
    if (index !== null && categorias && categorias[index]) {
      ...
      <div className="header-top">
        <div className="header-info">
          <div className="header-brand">
            <h1 className="header-logo">{comercio.nombre}</h1>
          </div>
      ...
      {tabs.length > 0 && (
        <div className="header-tabs">
          <ExpandableTabs
            ...
            activeColor="expandable-tabs-active-color"
